...
<header class="hud-top">
    ...
    <div class="telemetry-hud">
        ...
        <% } else { %>
            <span class="user-badge-est">&#128065;&#65039; MODO DOCENTE / EVALUADOR</span>
            <a href="<%= ctx %>/login" class="btn-exit" style="background:linear-gradient(135deg,#d884ff,#ff007f);border:none;color:#fff;box-shadow:0 0 15px rgba(216,132,255,.5);">&#128274; ACCESO ALUMNA</a>
        <% } %>
    </div>
</header>
