...
public class ArchivoServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res)
        ...
        // Si no hay sesión activa, entra en modo público / docente evaluador sin pedir login
        if (usuario == null) {
            usuario = new Usuario(2, "EST2026", "Visitante Académico / Auditor UPLA", "auditor@upla.edu.pe", 2);
        }
